        ...
        if (imageUri != null) {
            ...
            uploadTask.addOnFailureListener(new OnFailureListener() {
                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    ...
                    progressDialog.dismiss();
                    FireBaseCall.addItem(description.getText().toString().trim(), price.getText().toString().trim(), size.getText().toString().trim(), profilePicPath, getApplicationContext(), AddItem.this);
